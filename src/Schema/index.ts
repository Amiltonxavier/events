...
export const EventTypes = z.enum(
  CONSTANTS.EVENTSTYPESARRAY as [string, ...string[]]
);
...
export const CreateInviteSchema = z.object({
  email: z
    ...
    .nonempty("E-mail é um campo obrigatório"),
  amount: z.preprocess(
    (val) => Number(val),
    z
      .number()
      .min(1, "Tamanho mínimo aceite 1")
      .max(3, "Máxima de pessoas em um convite")
  ),
